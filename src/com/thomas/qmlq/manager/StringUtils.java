...
public class StringUtils {
	...
	public static void setTextTypeface(FontType type, Context context,
			TextView textView) {
		switch (type) {
		case ROBOTO_LIGHT:
			setTextFont(context, textView, BaseApplication.lightTypeface);
			break;
		case ROBOTO_THIN:
			setTextFont(context, textView, BaseApplication.thinypeface);
			break;
		case WENDY:
			setTextFont(context, textView, BaseApplication.wendyTypeface);
			break;
		case XIYUAN:
			setTextFont(context, textView, BaseApplication.xiyuanTypeface);
			break;
	...
	public static void setButtonFont(Context context, Button btnView,
			Typeface typeface) { 
		btnView.setTypeface(typeface);
	}

	public static void setButtonTypeface(FontType type, Context context,
			Button btnView) {
		switch (type) {
		case ROBOTO_LIGHT:
			setButtonFont(context, btnView, BaseApplication.lightTypeface);
			break;
		case ROBOTO_THIN:
			setButtonFont(context, btnView, BaseApplication.thinypeface);
			break;
		case WENDY:
			setButtonFont(context, btnView, BaseApplication.wendyTypeface);
			break;
		case XIYUAN:
			setButtonFont(context, btnView, BaseApplication.xiyuanTypeface);
			break;
	...
	public static void setEditTextFont(Context context, EditText edtView,
			Typeface typeface) {
		edtView.setTypeface(typeface);
	}

	public static void setEditTextTypeface(FontType type, Context context,
			EditText edtView) {
		switch (type) {
		case ROBOTO_LIGHT:
			setEditTextFont(context, edtView, BaseApplication.lightTypeface);
			break;
		case ROBOTO_THIN:
			setEditTextFont(context, edtView, BaseApplication.thinypeface);
			break;
		case WENDY:
			setEditTextFont(context, edtView, BaseApplication.wendyTypeface);
			break;
		case XIYUAN:
			setEditTextFont(context, edtView, BaseApplication.xiyuanTypeface);
			break;
	...
	public static void setCheckBoxFont(Context context, CheckBox edtView,
			Typeface typeface) {
		edtView.setTypeface(typeface);
	}

	public static void setCheckBoxTypeface(FontType type, Context context,
			CheckBox edtView) {
		switch (type) {
		case ROBOTO_LIGHT:
			setCheckBoxFont(context, edtView, BaseApplication.lightTypeface);
			break;
		case ROBOTO_THIN:
			setCheckBoxFont(context, edtView, BaseApplication.thinypeface);
			break;
		case WENDY:
			setCheckBoxFont(context, edtView, BaseApplication.wendyTypeface);
			break;
		case XIYUAN:
			setCheckBoxFont(context, edtView, BaseApplication.xiyuanTypeface);
			break;
