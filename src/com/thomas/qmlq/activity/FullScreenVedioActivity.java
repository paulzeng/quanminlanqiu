...
import com.thoams.qmlq.vedio.DensityUtil;
import com.thoams.qmlq.vedio.FullScreenVideoView;
import com.thoams.qmlq.vedio.LightnessController;
import com.thoams.qmlq.vedio.VolumnController;
import com.thomas.qmlq.R;

public class FullScreenVedioActivity extends BaseActivity implements OnClickListener{ 
	// 自定义VideoView
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_fullscreen_vedio);
		findViews();
		setListener();
		init();
	}
	...
	public void findViews() {
		...
		mVideo = (FullScreenVideoView) this.findViewById(R.id.videoview);
		mPlayTime = (TextView) this.findViewById(R.id.play_time);
		mDurationTime = (TextView) this.findViewById(R.id.total_time);
		mPlay = (ImageView) this.findViewById(R.id.play_btn);
		mSeekBar = (SeekBar) this.findViewById(R.id.seekbar);
		mTopView = this.findViewById(R.id.top_layout);
		mBottomView = this.findViewById(R.id.bottom_layout); 
	...
	private void playVideo() {
		String uri = "android.resource://" +  this.getPackageName() + "/" + R.raw.muse; 
		mVideo.setVideoPath(uri);
		mVideo.requestFocus();
